export class CommonService{
    ...
    static LOGOUT_API = "http://localhost:3000/logout";
    ...
    static DISTRICT_API = "https://vapi.vnappmob.com/api/province/district/";
    static WARD_API = "https://vapi.vnappmob.com/api/province/ward/";
}